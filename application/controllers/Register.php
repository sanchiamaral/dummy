...
class Register extends CI_Controller{
    ...
    function validation()
    {
        ...
        $this->form_validation->set_rules('user_email', 'Email Address', 'required|trim|valid_email|is_unique[tbl_register.email]');
        ...
        if($this->form_validation->run())
        {
            ...
            $id = $this->Tbl_register->insert($data);
            if($id > 0){
